(function(){"use strict"
var e=[],r=[]
"serviceWorker"in navigator&&navigator.serviceWorker.register("/glimmer_eats/sw.js",{scope:"/glimmer_eats/"}).then(function(r){for(var n=Promise.resolve(),t=0;t<e.length;t++)(function(t){n=n.then(function(){return e[t](r)})})(t)
