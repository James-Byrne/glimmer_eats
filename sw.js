...
return new RegExp("^"+n+"$")}function c(e,t){return!!t.find(function(t){return t.test(decodeURI(e))})}self.CACHE_BUSTER="1524240646829|0.7478344520252334",self.addEventListener("install",function(e){return self.skipWaiting()}),self.addEventListener("activate",function(e){return self.clients.claim()})
var i=["assets/glimmer-192x192-4bf7f0d4df2ab92104594a41588a21c2.png","assets/glimmer-eats-icon-f14de28324f40c0ef412c663e8a70fb8.png","app-821567f15393a440355778937af9d594.js","glimmer-512x512-287ec1eb23beaa19e728ac13f3a2717b.png","glimmer-logo-5153f9bb9b1b1b1c0944900cf072e514.png","index.html","manifest.json"],a="esw-asset-cache-1",r=i.map(function(e){return new URL(e,self.location).toString()}),s=function(){caches.open(a).then(function(e){return e.keys().then(function(t){t.forEach(function(t){-1===r.indexOf(t.url)&&e.delete(t)})})})}
...
var f=[],l=[]
self.INDEX_FILE_HASH="f304ab9164f7695d5c21a4a0d95c112b"
