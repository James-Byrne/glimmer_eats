...
return new RegExp("^"+n+"$")}function c(e,t){return!!t.find(function(t){return t.test(decodeURI(e))})}self.CACHE_BUSTER="1524218736006|0.9909465156087784",self.addEventListener("install",function(e){return self.skipWaiting()}),self.addEventListener("activate",function(e){return self.clients.claim()})
...
var f=[],l=[]
self.INDEX_FILE_HASH="9f8350106dfc406b4705e6134fec6d33"
