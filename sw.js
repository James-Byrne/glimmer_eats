...
return new RegExp("^"+n+"$")}function c(e,t){return!!t.find(function(t){return t.test(decodeURI(e))})}self.CACHE_BUSTER="1524347882606|0.9092354508295761",self.addEventListener("install",function(e){return self.skipWaiting()}),self.addEventListener("activate",function(e){return self.clients.claim()})
var i=["assets/glimmer-192x192-4bf7f0d4df2ab92104594a41588a21c2.png","assets/glimmer-eats-icon-f14de28324f40c0ef412c663e8a70fb8.png","app-93ff84951c4fb7e6138a39900a5442e5.js","glimmer-512x512-287ec1eb23beaa19e728ac13f3a2717b.png","glimmer-logo-5153f9bb9b1b1b1c0944900cf072e514.png","index.html","manifest.json"],a="esw-asset-cache-1",r=i.map(function(e){return new URL(e,self.location).toString()}),s=function(){caches.open(a).then(function(e){return e.keys().then(function(t){t.forEach(function(t){-1===r.indexOf(t.url)&&e.delete(t)})})})}
...
var f=[],l=[]
self.INDEX_FILE_HASH="fb705a9aeb2e33e59e980f98ab0c6026"
