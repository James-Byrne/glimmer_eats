...
return void 0!==e&&e.seen}append(t){let e=this.map,i=this.list,n=this.iterable,s=e[t.key]=new N(n,t)
return i.append(s),s}insertBefore(t,e){let i=this.map,n=this.list,s=this.iterable,o=i[t.key]=new N(s,t)
...
class lt extends R{constructor(t){super(t)}static create(t){return void 0===t?pt:null===t?dt:!0===t?mt:!1===t?ft:"number"==typeof t?new ct(t):new ut(t)}get(t){return pt}}class ut extends lt{constructor(){super(...arguments),this.lengthReference=null}get(t){if("length"===t){let t=this.lengthReference
...
this.buffer[t+1]=e}}class Rt{constructor(){this.labels=r(),this.targets=[]}label(t,e){this.labels[t]=e}target(t,e){this.targets.push({at:t,target:e})}patch(t){let e=this.targets,i=this.labels
for(let s=0;s<e.length;s++){var n=e[s]
let o=n.at,r=i[n.target]-o
t.patch(o,r)}}}class Nt{constructor(){this.encoder=new It([])}push(t){switch(arguments.length){case 1:return this.encoder.encode(t,0)
...
this.push(63,i,e)}get labels(){return this.labelsStack.current}startLabels(){this.labelsStack.push(new Rt)}stopLabels(){this.labelsStack.pop().patch(this.encoder)}pushComponentDefinition(t){this.push(59,this.constants.handle(t))}pushCurriedComponent(){this.push(61)}pushDynamicComponentInstance(){this.push(60)}resolveDynamicComponent(t){this.push(62,this.constants.serializable(t))}staticComponentHelper(t,e,i){let n=this.resolver.lookupComponentDefinition(t,this.referrer)
...
const Oe=Me.DOMTreeConstruction,Be=["javascript:","vbscript:"],Ie=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],Re=["EMBED"],Ne=["href","src","background","action"],Ze=["src"]
function De(t,e){return-1!==t.indexOf(e)}function je(t,e){return(null===t||De(Ie,t))&&De(Ne,e)}function Fe(t,e){return null!==t&&(De(Re,t)&&De(Ze,e))}function He(t,e){return je(t,e)||Fe(t,e)}function Ve(t,e,i,n){let s=null
...
return new Oi(h)}asLayout(){return this.layout?this.layout:this.layout=Ri(this.parsedLayout,this.options,!1)}asPartial(){return this.partial?this.partial:this.partial=Ri(this.parsedLayout,this.options,!0)}}function Ri(t,e,i){let s=t.block,o=t.referrer,r=s.hasEval,a=s.symbols,h=n({},e,{asPartial:i,referrer:o})
return new Ot(s.statements,t,h,{referrer:o,hasEval:r,symbols:a})}class Ni{get(t){return ji.create(this,t)}}class Zi extends Ni{constructor(){super(...arguments),this._lastRevision=null,this._lastValue=null}value(){let t=this.tag,e=this._lastRevision,i=this._lastValue
return e&&t.validate(e)||(i=this._lastValue=this.compute(),this._lastRevision=t.value()),i}}class Di extends R{constructor(){super(...arguments),this.children=r()}get(t){let e=this.children[t]
...
function B(t,e,i){return t instanceof z?t:g(t)?new z(t[0],t[1]):void 0===t||null===t?t:"object"==typeof t&&"x"in t&&"y"in t?new z(t.x,t.y):new z(t,e,i)}function I(t,e){if(t)for(var i=e?[t,e]:t,n=0,s=i.length;n<s;n++)this.extend(i[n])}function R(t,e){return!t||t instanceof I?t:new I(t,e)}function N(t,e){if(t)for(var i=e?[t,e]:t,n=0,s=i.length;n<s;n++)this.extend(i[n])}function Z(t,e){return t instanceof N?t:new N(t,e)}function D(t,e,i){if(isNaN(t)||isNaN(e))throw new Error("Invalid LatLng object: ("+t+", "+e+")")
...
return(t="number"==typeof t[0]||t instanceof z?B(t):R(t))instanceof I?(e=t.min,i=t.max):e=i=t,e.x>=this.min.x&&i.x<=this.max.x&&e.y>=this.min.y&&i.y<=this.max.y},intersects:function(t){t=R(t)
var e=this.min,i=this.max,n=t.min,s=t.max,o=s.x>=e.x&&n.x<=i.x,r=s.y>=e.y&&n.y<=i.y
return o&&r},overlaps:function(t){t=R(t)
var e=this.min,i=this.max,n=t.min,s=t.max,o=s.x>e.x&&n.x<i.x,r=s.y>e.y&&n.y<i.y
return o&&r},isValid:function(){return!(!this.min||!this.max)}},N.prototype={extend:function(t){var e,i,n=this._southWest,s=this._northEast
if(t instanceof D)e=t,i=t
else{if(!(t instanceof N))return t?this.extend(j(t)||Z(t)):this
...
return new N(a,h)}},V=i({},H,{wrapLng:[-180,180],R:6371e3,distance:function(t,e){var i=Math.PI/180,n=t.lat*i,s=e.lat*i,o=Math.sin((e.lat-t.lat)*i/2),r=Math.sin((e.lng-t.lng)*i/2),a=o*o+Math.cos(n)*Math.cos(s)*r*r,h=2*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))
...
ne(t)}Vt(t,e)})
t["_leaflet_touchstart"+i]=n,t.addEventListener(At,n,!1),Nt||(document.documentElement.addEventListener(At,jt,!0),document.documentElement.addEventListener(zt,Ft,!0),document.documentElement.addEventListener(Ot,Ht,!0),document.documentElement.addEventListener(Bt,Ht,!0),Nt=!0)}(t,i,n):"touchmove"===e?function(t,e,i){var n=function(t){(t.pointerType!==t.MSPOINTER_TYPE_MOUSE&&"mouse"!==t.pointerType||0!==t.buttons)&&Vt(t,e)}
t["_leaflet_touchmove"+i]=n,t.addEventListener(zt,n,!1)}(t,i,n):"touchend"===e&&function(t,e,i){var n=function(t){Vt(t,e)}
t["_leaflet_touchend"+i]=n,t.addEventListener(Ot,n,!1),t.addEventListener(Bt,n,!1)}(t,i,n),this}function jt(t){Rt[t.pointerId]=t,Zt++}function Ft(t){Rt[t.pointerId]&&(Rt[t.pointerId]=t)}function Ht(t){delete Rt[t.pointerId],Zt--}function Vt(t,e){for(var i in t.touches=[],Rt)t.touches.push(Rt[i])
...
return!1}function Re(t,e,i){var n=e||new z(0,0)
t.style[ye]=(dt?"translate("+n.x+"px,"+n.y+"px)":"translate3d("+n.x+"px,"+n.y+"px,0)")+(i?" scale("+i+")":"")}function Ne(t,e){t._leaflet_pos=e,_t?Re(t,e):(t.style.left=e.x+"px",t.style.top=e.y+"px")}function Ze(t){return t._leaflet_pos||new z(0,0)}if("onselectstart"in document)de=function(){Yt(window,"selectstart",ne)},me=function(){Jt(window,"selectstart",ne)}
...
return new N(e,i)},getMinZoom:function(){return void 0===this.options.minZoom?this._layersMinZoom||0:this.options.minZoom},getMaxZoom:function(){return void 0===this.options.maxZoom?void 0===this._layersMaxZoom?1/0:this._layersMaxZoom:this.options.maxZoom},getBoundsZoom:function(t,e,i){t=Z(t),i=B(i||[0,0])
var n=this.getZoom()||0,s=this.getMinZoom(),o=this.getMaxZoom(),r=t.getNorthWest(),a=t.getSouthEast(),h=this.getSize().subtract(i),l=R(this.project(a,n),this.project(r,n)).getSize(),u=_t?this.options.zoomSnap:1,c=h.x/l.x,p=h.y/l.y,d=e?Math.max(c,p):Math.min(c,p)
...
this._paneRenderers={},this._mapPane=this.createPane("mapPane",this._container),Ne(this._mapPane,new z(0,0)),this.createPane("tilePane"),this.createPane("shadowPane"),this.createPane("overlayPane"),this.createPane("markerPane"),this.createPane("tooltipPane"),this.createPane("popupPane"),this.options.markerZoomAnimation||(Me(t.markerPane,"leaflet-zoom-hide"),Me(t.shadowPane,"leaflet-zoom-hide"))},_resetView:function(t,e){Ne(this._mapPane,new z(0,0))
var i=!this._loaded
...
var n=this._zoom!==e
return this._zoom=e,this._lastCenter=t,this._pixelOrigin=this._getNewPixelOrigin(t),(n||i&&i.pinch)&&this.fire("zoom",i),this.fire("move",i)},_moveEnd:function(t){return t&&this.fire("zoomend"),this.fire("moveend")},_stop:function(){return T(this._flyToFrame),this._panAnim&&this._panAnim.stop(),this},_rawPanBy:function(t){Ne(this._mapPane,this._getMapPanePos().subtract(t))},_getZoomSpan:function(){return this.getMaxZoom()-this.getMinZoom()},_panInsideMaxBounds:function(){this._enforcingBounds||this.panInsideBounds(this.options.maxBounds)},_checkIfLoaded:function(){if(!this._loaded)throw new Error("Set map center and zoom first.")},_initEvents:function(t){this._targets={},this._targets[r(this._container)]=this
var e=t?Jt:Yt
...
return R([this.project(t.getSouthWest(),e)._subtract(n),this.project(t.getNorthWest(),e)._subtract(n),this.project(t.getSouthEast(),e)._subtract(n),this.project(t.getNorthEast(),e)._subtract(n)])},_getCenterLayerPoint:function(){return this.containerPointToLayerPoint(this.getSize()._divideBy(2))},_getCenterOffset:function(t){return this.latLngToLayerPoint(t).subtract(this._getCenterLayerPoint())},_limitCenter:function(t,e,i){if(!i)return t
...
return t.add(this._getBoundsOffset(n,e))},_getBoundsOffset:function(t,e,i){var n=R(this.project(e.getNorthEast(),i),this.project(e.getSouthWest(),i)),s=n.min.subtract(t.min),o=n.max.subtract(t.max),r=this._rebound(s.x,-o.x),a=this._rebound(s.y,-o.y)
...
Re(this._proxy,this.project(t.center,t.zoom),this.getZoomScale(t.zoom,1)),i===this._proxy.style[e]&&this._animatingZoom&&this._onZoomTransitionEnd()},this),this.on("load moveend",function(){var t=this.getCenter(),e=this.getZoom()
Re(this._proxy,this.project(t,e),this.getZoomScale(e,1))},this),this._on("unload",this._destroyAnimProxy,this)},_destroyAnimProxy:function(){Se(this._proxy),delete this._proxy},_catchTransitionEnd:function(t){this._animatingZoom&&t.propertyName.indexOf("transform")>=0&&this._onZoomTransitionEnd()},_nothingToAnimate:function(){return!this._container.getElementsByClassName("leaflet-zoom-animated").length},_tryAnimatedZoom:function(t,e,i){if(this._animatingZoom)return!0
...
this.fire("predrag",t),Ne(this._element,this._newPos),this.fire("drag",t)},_onUp:function(t){!t._simulated&&this._enabled&&this.finishDrag()},finishDrag:function(){for(var t in Ae(document.body,"leaflet-dragging"),this._lastTarget&&(Ae(this._lastTarget,"leaflet-drag-target"),this._lastTarget=null),si)Jt(document,si[t],this._onMove,this),Jt(document,ni[t],this._onUp,this)
...
return this.eachLayer(t.push,t),t},setZIndex:function(t){return this.invoke("setZIndex",t)},getLayerId:function(t){return r(t)}}),Si=Li.extend({addLayer:function(t){return this.hasLayer(t)?this:(t.addEventParent(this),Li.prototype.addLayer.call(this,t),this.fire("layeradd",{layer:t}))},removeLayer:function(t){return this.hasLayer(t)?(t in this._layers&&(t=this._layers[t]),t.removeEventParent(this),Li.prototype.removeLayer.call(this,t),this.fire("layerremove",{layer:t})):this},setStyle:function(t){return this.invoke("setStyle",t)},bringToFront:function(){return this.invoke("bringToFront")},bringToBack:function(){return this.invoke("bringToBack")},getBounds:function(){var t=new N
...
return new N(this._map.layerPointToLatLng(this._point.subtract(t)),this._map.layerPointToLatLng(this._point.add(t)))},setStyle:Mi.prototype.setStyle,_project:function(){var t=this._latlng.lng,e=this._latlng.lat,i=this._map,n=i.options.crs
...
for(t=0,n=0;t<h-1;t++)if(s=a[t],o=a[t+1],i=s.distanceTo(o),(n+=i)>e)return r=(n-e)/i,this._map.layerPointToLatLng([o.x-r*(o.x-s.x),o.y-r*(o.y-s.y)])},getBounds:function(){return this._bounds},addLatLng:function(t,e){return e=e||this._defaultShape(),t=j(t),e.push(t),this._bounds.extend(t),this.redraw()},_setLatLngs:function(t){this._bounds=new N,this._latlngs=this._convertLatLngs(t)},_defaultShape:function(){return pi(this._latlngs)?this._latlngs:this._latlngs[0]},_convertLatLngs:function(t){for(var e=[],i=pi(t),n=0,s=t.length;n<s;n++)i?(e[n]=j(t[n]),this._bounds.extend(e[n])):e[n]=this._convertLatLngs(t[n])
...
function Ri(t,e){var i,n,s,o,r="Feature"===t.type?t.geometry:t,a=r?r.coordinates:null,h=[],l=e&&e.pointToLayer,u=e&&e.coordsToLatLng||Ni
if(!a&&!r)return null
...
case"GeometryCollection":for(s=0,o=r.geometries.length;s<o;s++){var c=Ri({geometry:r.geometries[s],type:"Feature",properties:t.properties},e)
c&&h.push(c)}return new Si(h)
default:throw new Error("Invalid GeoJSON object.")}}function Ni(t){return new D(t[1],t[0],t[2])}function Zi(t,e,i){for(var n,s=[],o=0,r=t.length;o<r;o++)n=e?Zi(t[o],e-1,i):(i||Ni)(t[o]),s.push(n)
...
Re(this._image,i,e)},_reset:function(){var t=this._image,e=new I(this._map.latLngToLayerPoint(this._bounds.getNorthWest()),this._map.latLngToLayerPoint(this._bounds.getSouthEast())),i=e.getSize()
Ne(t,e.min),t.style.width=i.x+"px",t.style.height=i.y+"px"},_updateOpacity:function(){Be(this._image,this.options.opacity)},_updateZIndex:function(){this._image&&void 0!==this.options.zIndex&&null!==this.options.zIndex&&(this._image.style.zIndex=this.options.zIndex)},_overlayOnError:function(){this.fire("error")
...
this._zoomAnimated?Ne(this._container,t.add(i)):e=e.add(t).add(i)
...
Ne(this._container,e.add(i))},_adjustPan:function(){if(!(!this.options.autoPan||this._map._panAnim&&this._map._panAnim._inProgress)){var t=this._map,e=parseInt(ke(this._container,"marginBottom"),10)||0,i=this._container.offsetHeight+e,n=this._containerWidth,s=new z(this._containerLeft,-i-this._containerBottom)
...
"top"===o?t=t.add(B(-r/2+h.x,-a+h.y+l.y,!0)):"bottom"===o?t=t.subtract(B(r/2-h.x,-h.y,!0)):"center"===o?t=t.subtract(B(r/2+h.x,a/2-l.y+h.y,!0)):"right"===o||"auto"===o&&s.x<n.x?(o="right",t=t.add(B(h.x+l.x,l.y-a/2+h.y,!0))):(o="left",t=t.subtract(B(r+l.x-h.x,a/2-l.y-h.y,!0))),Ae(i,"leaflet-tooltip-right"),Ae(i,"leaflet-tooltip-left"),Ae(i,"leaflet-tooltip-top"),Ae(i,"leaflet-tooltip-bottom"),Me(i,"leaflet-tooltip-"+o),Ne(i,t)},_updatePosition:function(){var t=this._map.latLngToLayerPoint(this._latlng)
...
_t?Re(t.el,s,n):Ne(t.el,s)},_resetGrid:function(){var t=this._map,e=t.options.crs,i=this._tileSize=this.getTileSize(),n=this._tileZoom,s=this._map.getPixelWorldBounds(this._tileZoom)
...
return[o,r]},_tileCoordsToBounds:function(t){var e=this._tileCoordsToNwSe(t),i=new N(e[0],e[1])
...
this._initTile(o),this.createTile.length<2&&P(s(this._tileReady,this,t,null,o)),Ne(o,i),this._tiles[n]={el:o,coords:t,current:!0},e.appendChild(o),this.fire("tileloadstart",{tile:o,coords:t})},_tileReady:function(t,e,i){if(this._map){e&&this.fire("tileerror",{error:e,tile:i,coords:t})
...
this.wmsParams[e]=this._crs.code,Qi.prototype.onAdd.call(this,t)},getTileUrl:function(t){var e=this._tileCoordsToNwSe(t),i=this._crs,n=R(i.project(e[0]),i.project(e[1])),s=n.min,o=n.max,r=(this._wmsVersion>=1.3&&this._crs===wi?[s.y,s.x,o.y,o.x]:[s.x,s.y,o.x,o.y]).join(","),a=L.TileLayer.prototype.getTileUrl.call(this,t)
...
Ne(e,t.min),e.width=n*i.x,e.height=n*i.y,e.style.width=i.x+"px",e.style.height=i.y+"px",St&&this._ctx.scale(2,2),this._ctx.translate(-t.min.x,-t.min.y),this.fire("update")}},_reset:function(){nn.prototype._reset.call(this),this._postponeUpdatePaths&&(this._postponeUpdatePaths=!1,this._updatePaths())},_initPath:function(t){this._updateDashArray(t),this._layers[r(t)]=t
...
this._svgSize&&this._svgSize.equals(e)||(this._svgSize=e,i.setAttribute("width",e.x),i.setAttribute("height",e.y)),Ne(i,t.min),i.setAttribute("viewBox",[t.min.x,t.min.y,e.x,e.y].join(" ")),this.fire("update")}},_initPath:function(t){var e=t._path=hn("path")
...
ln.create=hn,ln.pointsToPath=K,Ii.geometryToLayer=Ri,Ii.coordsToLatLng=Ni,Ii.coordsToLatLngs=Zi,Ii.latLngToCoords=Di,Ii.latLngsToCoords=ji,Ii.getFeature=Fi,Ii.asFeature=Hi,Ge.mergeOptions({boxZoom:!0})
...
this._offsetLimit=R(this._map.latLngToContainerPoint(e.getNorthWest()).multiplyBy(-1),this._map.latLngToContainerPoint(e.getSouthEast()).multiplyBy(-1).add(this._map.getSize())),this._viscosity=Math.min(1,Math.max(0,this._map.options.maxBoundsViscosity))}else this._offsetLimit=null
...
var yn=window.L
window.L=t,Object.freeze=e,t.version="1.3.1",t.noConflict=function(){return window.L=yn,this},t.Control=qe,t.control=$e,t.Browser=Mt,t.Evented=A,t.Mixin=ei,t.Util=E,t.Class=C,t.Handler=Qe,t.extend=i,t.bind=s,t.stamp=r,t.setOptions=d,t.DomEvent=ve,t.DomUtil=Ue,t.PosAnimation=We,t.Draggable=oi,t.LineUtil=mi,t.PolyUtil=_i,t.Point=z,t.point=B,t.Bounds=I,t.bounds=R,t.Transformation=W,t.transformation=G,t.Projection=yi,t.LatLng=D
...
var Rn=function(t,e,i,n){return new(i||(i=Promise))(function(s,o){function r(t){try{h(n.next(t))}catch(t){o(t)}}function a(t){try{h(n.throw(t))}catch(t){o(t)}}function h(t){t.done?s(t.value):new i(function(e){e(t.value)}).then(r,a)}h((n=n.apply(t,e||[])).next())})}
const Nn={attribution:"",accessToken:"pk.eyJ1IjoiamFtZXNkZXNieXJuZSIsImEiOiJjamR5dG5qODQxM3VtMzNxcDU1dXdrdmJ3In0.hJM4sfiAwMEC2bndm5JXIg",leafletUrl:"https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}",maxZoom:17,startingZoom:14}
function Zn(t,e=53.35,i=-6.27,n={}){return On.map(t,n).setView([e,i],Nn.startingZoom)}function Dn(t){return On.tileLayer(Nn.leafletUrl,{attribution:Nn.attribution,maxZoom:Nn.maxZoom,id:"mapbox.streets",accessToken:Nn.accessToken}).addTo(t)}function jn(t,e={}){return Rn(this,void 0,void 0,function*(){return yield(yield function(t,{results_start:e=""}){var i=t.latitude
const n=void 0===i?53.35:i
var s=t.longitude
const o=`${Bn}/search?entity_id=91&entity_type=city&lat=${n}&lon=${void 0===s?-6.27:s}&start=${e}`
return fetch(o,In)}(t,e)).json()})}function Fn(t){return Rn(this,void 0,void 0,function*(){return yield(yield function(t){var e=t.latitude
const i=void 0===e?53.35:e
var n=t.longitude
const s=`${Bn}/geocode?lat=${i}&lon=${void 0===n?-6.27:n}`
return fetch(s,In)}(t)).json()})}function Hn(t,e,i){var n=e.location
const s=n.latitude,o=n.longitude
return On.marker([s,o]).on("click",i).addTo(t),e}function Vn(){return JSON.parse(localStorage.getItem("favouritedRestaurants"))}var Un=function(t,e,i,n){var s,o=arguments.length,r=o<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n
